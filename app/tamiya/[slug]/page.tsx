    ...
    return (
        <div>
          ...
          <p className="text-center text-xl">{post.data.subtitle}</p>
            ...
            <p className="text-center mt-16">Visit Tamiya here</p>
            <Link className="grid justify-center" href="https://www.tamiyausa.com/" rel="noopener noreferrer" target="_blank">
                <Image src="/Tamiya-logo.png" height={100} width={120} alt=""></Image>
            </Link>
        </div>
    );
}
