const HomePage = () => {
    return (
        <main>
            <div className="text-center font-serif mx-10">
                <h1 className="text-3xl md:text-5xl my-16 underline font-bold">Welcome to my hobby blog!</h1>
                <p className="text-xl my-10">In this blog I have taken pictures to display my collection of different vehicle models and miniature figures that I've painted by myself and much more.</p>
                ...
                <p className="text-md mt-10 font-bold underline">!This site is still in early phase and more things will get added at some point in the near future!</p>
            </div>
        </main>
    );
}
