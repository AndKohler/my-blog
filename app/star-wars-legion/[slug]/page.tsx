    ...
    return (
        <div>
          ...
          <p className="text-center mt-0 mb-6">1/72 scale</p>
            ...
            <Link scroll={true} className="grid justify-center" href="https://www.fantasyflightgames.com/en/products/star-wars-legion/" rel="noopener noreferrer" target="_blank">
            <Image src="/SW-Legion-logo.png" height={65} width={210} alt=""></Image>
            </Link>
        </div>
    );
}
